...
const Pagination: React.FC<PaginationProps> = ({
  ...
  const PillGroupPagination = () => {
    ...
    return (
      <div
        className={cn(
          "inline-flex items-center bg-input-background rounded-full p-1",
          className
        )}
      >
        <button
    ...
    return (
      <div className={cn("w-full max-w-md", className)}>
        <div className="flex justify-between items-center mb-2">
          ...
          <span
            className={cn(sizeStyles.text, "font-medium text-text-primary")}
          >
  ...
  return (
    <div className={cn("flex", alignmentClasses[align])}>{renderVariant()}</div>
  );
};
