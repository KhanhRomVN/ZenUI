        ...
        <section id="examples" className="mb-12">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              Complete table with sorting, pagination, custom rendering, and
              actions.
            </p>
            ...
            <CodeBlock
              code={`import { Table } from "@khanhromvn/zenui";
...
function FullFeaturedTable() {
  ...
  return (
    ...
    />
              ...
              headerMode="path"
              headerIcon={<FileCode size={16} />}
              filePath="src/components/FullFeaturedTable.tsx"
              showLineNumbers={true}
            />
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              Different table styles including bordered and striped variants.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <div className="bg-card-background border border-border-default rounded-lg p-4">
                  <Table
...
function TableVariants() {
  ...
  return (
    <div className="space-y-6">
      {/* Bordered Table */}
      <div>
        <h4 className="text-lg font-semibold mb-2">Bordered Table</h4>
        <Table
          data={data}
          columns={columns}
          variant="bordered"
      ...
      {/* Striped Table */}
      <div>
        <h4 className="text-lg font-semibold mb-2">Striped Table</h4>
        <Table
          data={data}
          columns={columns}
          variant="striped"
        ...
        />
              ...
              headerMode="path"
              headerIcon={<FileCode size={16} />}
              filePath="src/components/TableVariants.tsx"
              showLineNumbers={true}
            />
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              Server-side and client-side pagination with complete controls.
            </p>
            ...
            <CodeBlock
              ...
              headerMode="path"
              headerIcon={<FileCode size={16} />}
              filePath="src/components/PaginatedTable.tsx"
              showLineNumbers={true}
            />
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              For maximum flexibility, you can use table sub-components
              directly.
            </p>
            ...
            <div className="bg-card-background border border-border-default rounded-lg p-4 mb-6">
              <div className="border border-table-border rounded-lg overflow-hidden">
                <Table>
                  <Table.Header>
                    <Table.Row className="bg-table-headerBg">
                  ...
                  <Table.Body>
                    <Table.Row className="hover:bg-table-rowOddHover cursor-pointer">
                    ...
                    <Table.Row className="hover:bg-table-rowEvenHover cursor-pointer">
                  ...
                  <Table.Footer>
                    <Table.Row className="bg-table-footerBg">
                      <Table.Cell colSpan={4} align="center">
                        Showing 2 of 25 records
                      </Table.Cell>
                    </Table.Row>
                  </Table.Footer>
                </Table>
            ...
            <CodeBlock
              code={subComponentsExampleCode}
              language="typescript"
              theme="vs-dark"
              readOnly={true}
              headerMode="path"
              headerIcon={<FileCode size={16} />}
              filePath="src/components/CustomTable.tsx"
              showLineNumbers={true}
            />
          </div>
        </section>
